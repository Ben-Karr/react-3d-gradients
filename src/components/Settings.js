...
export function Settings({ currentAB, setCurrentAB, loss , lrExponent, setLrExponent, onStep, onClear}) {
    ...
    return (
        <>
            ...
            <Slider 
                onChange={a => {
                    setCurrentAB(prevAB => [a,prevAB[1]]);
                    onClear();
                }}
                min={-1} 
                max={6-0.33333} 
            ...
            <Slider 
                onChange={b => {
                    setCurrentAB(prevAB => [prevAB[0], b]);
                    onClear();
                }}
                min={-4} 
                max={8-0.4} 
